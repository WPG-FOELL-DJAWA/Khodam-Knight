...
namespace EasyTransition
{
    ...
    public class TransitionManager : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="MapName">The name of the scene you want to load.</param>
        ...
        public void LoadScene(string MapName, string transitionID, float loadDelay)
        {
            ...
            StartCoroutine(Timer(MapName, loadDelay, transitionSettings));
        }
        ...
        /// </summary>
        /// <param name="MapName">The name of the scene you want to get the index of.</param>
        public int GetSceneIndex(string MapName)
        {
            return SceneManager.GetSceneByName(MapName).buildIndex;
        }

        IEnumerator Timer(string MapName, float time, TransitionSettings transitionSettings)
        {
